...
CREATE TABLE public.single_environment_variables (
    id integer NOT NULL,
    name text NOT NULL,
    value text NOT NULL,
    single_deployment_id integer NOT NULL
);
CREATE SEQUENCE public.single_environment_variables_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
    CACHE 1;
ALTER SEQUENCE public.single_environment_variables_id_seq OWNED BY public.single_environment_variables.id;
...
ALTER TABLE ONLY public.single_environment_variables ALTER COLUMN id SET DEFAULT nextval('public.single_environment_variables_id_seq'::regclass);
...
ALTER TABLE ONLY public.single_environment_variables
    ADD CONSTRAINT single_environment_variables_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY public.single_environment_variables
    ADD CONSTRAINT single_environment_variables_single_deployment_id_fkey FOREIGN KEY (single_deployment_id) REFERENCES public.single_deployment(id) ON UPDATE CASCADE ON DELETE CASCADE;
